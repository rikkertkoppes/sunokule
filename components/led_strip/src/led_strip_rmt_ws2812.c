...
#define WS2812_T0H_NS (350)    // 350 +/- 150  was 350
#define WS2812_T0L_NS (1000)   // 900 +/- 150  was 1000
#define WS2812_T1H_NS (1000)   // 900 +/- 150  was 1000
#define WS2812_T1L_NS (350)    // 350 +/- 150  was 350
#define WS2812_RESET_US (280)  // 50+          was 280
...
static esp_err_t ws2812_refresh_immediate(led_strip_t *strip) {
    esp_err_t ret = ESP_OK;
    ws2812_t *ws2812 = __containerof(strip, ws2812_t, parent);
    STRIP_CHECK(
...
static esp_err_t ws2812_wait(led_strip_t *strip, uint32_t timeout_ms) {
    esp_err_t ret = ESP_OK;
    ws2812_t *ws2812 = __containerof(strip, ws2812_t, parent);
...
led_strip_t *led_strip_new_rmt_ws2812(const led_strip_config_t *config) {
    ...
    ws2812->parent.refresh_immediate = ws2812_refresh_immediate;
    ws2812->parent.wait = ws2812_wait;
